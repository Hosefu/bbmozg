...
namespace Lauf.Infrastructure.Migrations
{
    ...
    [Migration("20250628004047_InitialNewArchitecture")]
    partial class InitialNewArchitecture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lauf.Domain.Entities.Flows.FlowAssignmentProgress", b =>
                {
                    ...
                    b.Property<Guid>("FlowAssignmentId1")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Lauf.Domain.Entities.Flows.FlowAssignmentProgress", b =>
                {
                    ...
                    b.HasOne("Lauf.Domain.Entities.Flows.FlowAssignment", "FlowAssignment")
                        .WithMany()
                        .HasForeignKey("FlowAssignmentId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
