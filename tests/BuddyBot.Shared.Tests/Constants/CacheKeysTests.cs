...
public class CacheKeysTests
{
    ...
    {
        // Act & Assert
        CacheKeys.Prefix.Should().Be("BuddyBot:");
    }
    ...
    public void Users_ById_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:User:123");
    }
    ...
    public void Users_ByTelegramId_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:User:Telegram:456789");
    }
    ...
    public void Users_Roles_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:User:123:Roles");
    }
    ...
    {
        // Act & Assert
        CacheKeys.Users.All.Should().Be("BuddyBot:Users:All");
    }
    ...
    public void Flows_ById_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:Flow:456");
    }
    ...
    public void Flows_AvailableForUser_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:Flows:Available:789");
    }
    ...
    public void Assignments_ById_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:Assignment:111");
    }
    ...
    public void Progress_ByAssignment_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:Progress:Assignment:222");
    }
    ...
    public void Notifications_UnreadCount_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:Notifications:User:333:UnreadCount");
    }
    ...
    public void RateLimit_ForUser_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:RateLimit:User:444");
    }
    ...
    public void RateLimit_ForIp_ShouldGenerateCorrectKey()
    {
        ...
        // Assert
        result.Should().Be("BuddyBot:RateLimit:IP:192.168.1.1");
    }
    ...
    {
        // Act & Assert
        CacheKeys.System.Settings.Should().Be("BuddyBot:System:Settings");
        CacheKeys.System.WorkingHours.Should().Be("BuddyBot:System:WorkingHours");
        CacheKeys.System.Holidays.Should().Be("BuddyBot:System:Holidays");
    }
    ...
    {
        // Act & Assert
        CacheKeys.Achievements.All.Should().Be("BuddyBot:Achievements:All");
    }
    ...
    public void CacheKeys_WithNumericIds_ShouldHandleDifferentValues(int id)
    {
        ...
        // Assert
        userKey.Should().Be($"BuddyBot:User:{id}");
        flowKey.Should().Be($"BuddyBot:Flow:{id}");
        assignmentKey.Should().Be($"BuddyBot:Assignment:{id}");
    }
